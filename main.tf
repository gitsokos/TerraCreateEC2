...
resource "aws_instance" "master" {
  ami           = var.master_ami # "ami-0c6ebbd55ab05f070"
...
#  subnet_id     = "subnet-2348273423"
  ...
  user_data = templatefile("pe-install-wnode.ps1",{master_private_dns=aws_instance.master.private_dns }) # "pe-install-wnode.ps1"
  user_data_replace_on_change = var.user_data_replace_on_change_w_node # true 
...
resource "aws_key_pair" "key_pair" { # "deployer" {
...
resource "aws_key_pair" "w_key_pair" { # "deployer" {
